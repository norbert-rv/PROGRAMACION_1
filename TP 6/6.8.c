/* Realizar un programa que permita gestionar los datos de productos alimenticios de un almacén. Mostrar
en pantalla un menú interactivo de opciones, con la finalidad de guardar en un archivo binario llamado
alimentos.dat.
○ La información a almacenar de cada producto es: nombre comercial, marca, precio, mes y año
de vencimiento. Considerar controles que crea pertinentes. El nombre comercial puede
contener letras, dígitos y espacios.
○ El menú deberá contener las siguientes opciones:
    1 - Ingresar información de un nuevo producto
    2- Mostrar en pantalla los datos de todos los productos
    3- Ordenar el archivo en forma alfabética por nombre comercial: ordena de manera
    ascendente los productos en el archivo
    4- Consulta de productos por nombre comercial: muestra todos los productos en caso de
    haber coincidencias o un mensaje.
