...
void ordenarAlfabeticamente(int cantidadHuespedes, huesped listaHuespedes[]);
...
int main(int argc, char *argv[]) {
    ...
    ordenarAlfabeticamente(cantidadHuespedes, listaHuespedes);
...
void ordenarAlfabeticamente(int cantidadHuespedes, huesped listaHuespedes[]) {
    ...
    for (int i = 0; i < cantidadHuespedes; i++) {
        for (j = 0; j < cantidadHuespedes - 1; j++) {
            if (strcmp(listaHuespedes[j].apellido, listaHuespedes[i].apellido) > 0) {
                auxiliar = listaHuespedes[i];
                listaHuespedes[i] = listaHuespedes[j];
                listaHuespedes[j] = auxiliar;
            }
        }
    }
}